 ...
 * Modified 06/2017
 */
public class ErgoDotaMapView extends AppCompatImageView {

    private Collection<MapContainer> mMapCollection;
    private Drawable mTowerDrawable;
    private Drawable mBarracksDrawable;

    public ErgoDotaMapView(final Context context) {
        this(context, null);
    }

    public ErgoDotaMapView(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ErgoDotaMapView(final Context context, final AttributeSet attrs, final int defStyleAttr) {
    ...
    private void addDrawableColourFilter(final Drawable drawable, final MapContainer mapObject) {
        ...
        if (mapObject.isRadiant() && !mapObject.isDestroyed()) {
            drawable.setColorFilter(getColor(R.color.md_green_300), PorterDuff.Mode.SRC_ATOP);
            ...
            drawable.setColorFilter(getColor(R.color.md_red_400), PorterDuff.Mode.SRC_ATOP);
        } else {
