...
public class MainActivity extends BaseActivity {
    ...
    protected void init(final @Nullable Bundle savedInstanceState) {
        ...
        initDrawer(
                getDrawerFactory(savedInstanceState),
    ...
    private DrawerFactory getDrawerFactory(final @Nullable Bundle savedInstanceState) {
        initDrawerImageLoader();
        mDrawerFactory = new DrawerFactory(this, savedInstanceState, getNavigationListener());
        return mDrawerFactory;
    }

    private AccountHeader getAccountHeader(final List<PlayerEntity> playerEntities,
                                           @Nullable final String currentUserId) {
        mAccountHeader = getDrawerFactory(null).getAccountHeader(playerEntities, currentUserId);
