package com.michaelfotiadis.dota2viewer.data.persistence.db;

import android.arch.persistence.room.Database;
import android.arch.persistence.room.RoomDatabase;

import com.michaelfotiadis.dota2viewer.data.persistence.db.dao.DotaHeroDao;
import com.michaelfotiadis.dota2viewer.data.persistence.db.dao.DotaItemDao;
import com.michaelfotiadis.dota2viewer.data.persistence.db.dao.DotaLeagueDao;
import com.michaelfotiadis.dota2viewer.data.persistence.db.dao.DotaMatchDetailsDao;
import com.michaelfotiadis.dota2viewer.data.persistence.db.dao.DotaMatchOverviewDao;
...
import com.michaelfotiadis.dota2viewer.data.persistence.db.model.DotaMatchOverviewEntity;
