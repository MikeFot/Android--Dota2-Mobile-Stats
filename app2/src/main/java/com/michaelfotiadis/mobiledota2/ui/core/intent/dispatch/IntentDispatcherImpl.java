...
import com.michaelfotiadis.mobiledota2.ui.core.intent.chromecustomtabs.CustomTabActivityHelper;
import com.michaelfotiadis.mobiledota2.ui.core.intent.factory.IntentFactory;
import com.michaelfotiadis.mobiledota2.ui.core.intent.factory.IntentFactoryImpl;
...
public class IntentDispatcherImpl implements IntentDispatcher {
    ...
    private void openUrlDefault(final View source, final Uri uri) {
        ...
        Answers.getInstance().logContentView(new ContentViewEvent().putContentName("Opened URI"));
