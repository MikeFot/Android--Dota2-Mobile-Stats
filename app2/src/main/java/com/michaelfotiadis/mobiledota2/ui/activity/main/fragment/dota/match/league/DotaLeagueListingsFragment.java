package com.michaelfotiadis.mobiledota2.ui.activity.main.fragment.dota.match.league;
...
import com.michaelfotiadis.mobiledota2.ui.activity.main.fragment.dota.match.league.recycler.LeagueListingRecyclerAdapter;
import com.michaelfotiadis.mobiledota2.ui.activity.main.fragment.dota.match.league.recycler.LeaguesRecyclerContentUpdater;
    ...
    public void submitQuery(final String query) {
        if (TextUtils.isEmpty(query)) {
            ...
            Answers.getInstance().logSearch(
                    new SearchEvent().putQuery(query).putCustomAttribute("Screen", "Dota Leagues"));
