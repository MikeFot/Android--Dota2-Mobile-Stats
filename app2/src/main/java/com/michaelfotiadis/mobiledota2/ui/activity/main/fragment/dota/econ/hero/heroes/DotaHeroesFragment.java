package com.michaelfotiadis.mobiledota2.ui.activity.main.fragment.dota.econ.hero.heroes;
...
import com.michaelfotiadis.mobiledota2.ui.activity.main.fragment.dota.econ.hero.heroes.recycler.GameHeroRecyclerAdapter;
...
public class DotaHeroesFragment extends BaseRecyclerFragment<Hero> implements OnItemSelectedListener<Hero>, Searchable {
    ...
    protected RecyclerManager<Hero> mRecyclerManager;
    @Inject
    ...
    @Override
    protected RecyclerManager<Hero> getRecyclerManager() {
    ...
    public void submitQuery(final String query) {
        ...
        if (TextUtils.isEmpty(query)) {
            ...
            Answers.getInstance().logSearch(
                    new SearchEvent().putQuery(query).putCustomAttribute("Screen", "Dota Heroes"));
