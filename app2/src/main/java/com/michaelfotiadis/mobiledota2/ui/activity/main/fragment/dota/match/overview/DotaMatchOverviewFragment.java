package com.michaelfotiadis.mobiledota2.ui.activity.main.fragment.dota.match.overview;
...
import com.michaelfotiadis.mobiledota2.ui.activity.main.fragment.dota.match.overview.model.MatchDetailsItem;
...
import com.michaelfotiadis.mobiledota2.ui.activity.main.fragment.dota.match.overview.recycler.MatchRecyclerAdapter;
import com.michaelfotiadis.mobiledota2.ui.activity.main.fragment.dota.match.overview.recycler.MatchRecyclerManager;
...
import com.michaelfotiadis.mobiledota2.ui.core.base.recyclerview.listener.EndlessRecyclerOnScrollListener;
...
public class DotaMatchOverviewFragment extends BaseFragment implements OnItemSelectedListener<MatchItem> {
    ...
    public void onAttach(final Context context) {
        ...
        Answers.getInstance().logContentView(new ContentViewEvent()
                .putContentName("Dota Match Overview")
